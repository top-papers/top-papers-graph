    ...
    with temporary_llm_selection(
        ...
        with temporary_vlm_selection(vlm_backend=vlm_backend, vlm_model_id=vlm_model_id):
            ...
            manifest = {
                ...
                "gold_graph": str(out / "reference_graph.json"),
                "gold_triplets_csv": str(out / "reference_triplets.csv"),
                "gold_graph_html": str(out / "reference_graph_light.html"),
                "gold_graph_html_light": str(out / "reference_graph_light.html"),
                "gold_graph_html_full": str(out / "reference_graph.html"),
                "gold_graph_analytics": str(out / "reference_graph_analytics.json"),
                "auto_graph_json": str(out / "automatic_graph" / "temporal_kg.json"),
                "auto_triplets_csv": str(out / "automatic_triplets.csv"),
                "auto_graph_html": str(out / "automatic_graph_light.html"),
                "auto_graph_html_light": str(out / "automatic_graph_light.html"),
                "auto_graph_html_full": str(out / "automatic_graph.html"),
                "auto_graph_analytics": str(out / "automatic_graph_analytics.json"),
                "comparison_summary": str(out / "comparison_summary.json"),
                "filter_defaults": {
